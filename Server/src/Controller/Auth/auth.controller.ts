...
import {UserModel , TeacherAuth , CodeModel  } from "@CampusLink/Server/Model"
...
async function handleLogin(req:any, res:any) {
    ...
    try {
        ...
        const teacher = await TeacherAuth.findOne({ email });
...
try{
    ...
    const existemail=await TeacherAuth.findOne({email})
    ...
    const user=await TeacherAuth.create({
